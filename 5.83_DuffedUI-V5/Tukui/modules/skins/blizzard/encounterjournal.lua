...
local function LoadSkin()
	if T.toc >= 40200 then
		...
		EncounterJournal:HookScript("OnShow", function()
			...
			EncounterJournalEncounterFrameInfoBossTab:Point("TOPLEFT", EncounterJournal, "TOPRIGHT",  -10,  -50)
			EncounterJournalEncounterFrameInfoLootTab:ClearAllPoints()
			EncounterJournalEncounterFrameInfoLootTab:Point("TOPLEFT", EncounterJournalEncounterFrameInfoBossTab, "BOTTOMLEFT",  0,  0)
