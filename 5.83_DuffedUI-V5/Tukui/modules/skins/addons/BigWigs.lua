...
local applystyle = function(bar)
	...
	bar.candyBarLabel:SetFont(C.media.font, C["datatext"].fontsize, C["unitframes"].outline)
	bar.candyBarLabel:SetShadowColor(0, 0, 0, 0)
	bar.candyBarLabel:SetJustifyH("LEFT")
	bar.candyBarLabel:ClearAllPoints()
	bar.candyBarLabel:Point("LEFT", bar, "LEFT", 4, 0)
	
	bar.candyBarDuration:SetFont(C.media.font, C["datatext"].fontsize, C["unitframes"].outline)
