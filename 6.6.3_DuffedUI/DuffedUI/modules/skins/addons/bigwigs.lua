...
local barcolor = classcolor and RAID_CLASS_COLORS[T.myclass]
local buttonsize
...
SlashCmdList["DUFFEDUIBIGWIGS"] = function(msg)
	if msg == "apply" then
		...
		T.ShowPopup("DUFFEDUI_ENABLE_BIGWIGS_SKIN")
...
T.CreatePopup["DUFFEDUI_ENABLE_BIGWIGS_SKIN"] = {
