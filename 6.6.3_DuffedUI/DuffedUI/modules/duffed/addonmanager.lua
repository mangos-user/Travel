...
addonHeader.Text = T.SetFontString(addonHeader, T.CreateFontString())
addonHeader.Text:SetPoint("LEFT", 5, 1)
addonHeader.Text:SetText(T.color.."AddOns List"..": "..T.color..T.myname)
...
saveButton.Text = T.SetFontString(saveButton, T.CreateFontString())
saveButton.Text:Point("CENTER", saveButton, "CENTER", 1, 1)
saveButton.Text:SetText(T.color.."Save Changes")
...
closeButton.Text = T.SetFontString(closeButton, T.CreateFontString())
closeButton.Text:Point("CENTER", closeButton, "CENTER", 1, 1)
closeButton.Text:SetText(T.color.."Cancel")
...
local function UpdateAddons()
	...
	for i,v in pairs(addons) do
		...
		local text = T.SetFontString(button, T.CreateFontString())
