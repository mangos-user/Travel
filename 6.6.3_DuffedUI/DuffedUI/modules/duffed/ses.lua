...
if C["chat"].background then
	spec:SetPoint("RIGHT", TukuiButtonCF4, "LEFT", -2, 0)
else
	spec:SetPoint("BOTTOMRIGHT", ChatFrame4, "TOPRIGHT", -3, 0)
end
...
spec.t:SetFont(T.CreateFontString())
