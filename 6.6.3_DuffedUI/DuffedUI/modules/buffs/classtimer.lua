...
do
	...
	do
		...
		CreateAuraBar = function(parent)
			...
			stacks:SetFont(T.CreateFontString());
			...
			time:SetFont(T.CreateFontString());
...
if C["unitframes"].layout == 1 then
	if G.UnitFrames.Player.ArcaneChargeBar or G.UnitFrames.Player.Runes or G.UnitFrames.Player.HarmonyBar or G.UnitFrames.Player.TotemBar or G.UnitFrames.Player.HolyPower or G.UnitFrames.Player.WarlockSpecBars or G.UnitFrames.Player.ShadowOrbsBar then
		playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 14)
		playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 14)
	else
		playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 7)
		playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 7)
	end
	
	if T.myclass == "DRUID" then
		if G.UnitFrames.Player.WildMushroom:IsShown() and G.UnitFrames.Player.EclipseBar:IsShown() then
			playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 30)
			playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 30)
		elseif G.UnitFrames.Player.EclipseBar:IsShown() then
			playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 15)
			playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 15)
		end
		G.UnitFrames.Player.WildMushroom:HookScript("OnShow", function(self)
			playerFrame:Point("BOTTOMLEFT", self, "TOPLEFT", -1, 7)
			playerFrame:Point("BOTTOMRIGHT", self, "TOPRIGHT", 1, 7)
		end)
		G.UnitFrames.Player.WildMushroom:HookScript("OnHide", function(self)
			playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 7)
			playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 7)
		end)
		G.UnitFrames.Player.EclipseBar:HookScript("OnShow", function(self)
			playerFrame:Point("BOTTOMLEFT", self, "TOPLEFT", -1, 7)
			playerFrame:Point("BOTTOMRIGHT", self, "TOPRIGHT", 1, 7)
		end)
		G.UnitFrames.Player.EclipseBar:HookScript("OnHide", function(self)
			playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -1, 7)
			playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", 1, 7)
		end)
	end
...
elseif C["unitframes"].layout == 3 then
	playerFrame:Point("BOTTOMLEFT", TukuiPlayer, "TOPLEFT", -12, 19)
	playerFrame:Point("BOTTOMRIGHT", TukuiPlayer, "TOPRIGHT", -1, 19)
end
...
if not targetdebuffs then
	...
	targetFrame:SetHiddenHeight(-yOffset)
	targetFrame:Point("BOTTOMLEFT", TukuiTarget, "TOPLEFT", 0, 83)
	targetFrame:Point("BOTTOMRIGHT", TukuiTarget, "TOPRIGHT", 0, 103)
end