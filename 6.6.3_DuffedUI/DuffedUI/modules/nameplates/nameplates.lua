...
if C["nameplate"].duffed ~= true then return end
...
local function UpdateAuraIcon(button, unit, index, filter)
	...
	button.cd:SetScript("OnUpdate", function(self)
		...
		button.cd.timer.text:SetFont(T.CreateFontString())
...
local function SkinObjects(frame)
	...
	hp.level:SetFont(T.CreateFontString())
	...
	if C["nameplate"].showhealth == true then
		...
		hp.value:SetFont(T.CreateFontString())
	...
	hp.name:SetFont(T.CreateFontString())
	...
	cb.time:SetFont(T.CreateFontString())
	...
	if C["nameplate"].showcastbarname == true then
		...
		cb.name:SetFont(T.CreateFontString())
